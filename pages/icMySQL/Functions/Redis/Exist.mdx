...
# Delete
The exist function is to get if a data exist in the memory.
...
<Tab>
```lua
exports["ice_mysql"]:RedisExists(key, function)
```
</Tab>
<Tab>
```lua
MySQL.Redis.RedisExists(key, function)
```
</Tab>
</Tabs>
...
<Tab>
```lua
local result = MySQL.Redis.RedisExists("name")
```
</Tab>
<Tab>
```js
...
<Tab>
```cs
var result = await MySQL.Redis.RedisExists("name")
```
</Tab>
</Tabs>
